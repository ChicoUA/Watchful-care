...
public class VenderActivity extends AppCompatActivity {
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    String imageName = getFileName(contentURI);

                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(VenderActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            saveImage(thumbnail);
            Toast.makeText(VenderActivity.this, "Image Saved!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public String getFileName(Uri uri) {
        ...
        Toast.makeText(VenderActivity.this, result, Toast.LENGTH_SHORT).show();
        return result;
    }
}
